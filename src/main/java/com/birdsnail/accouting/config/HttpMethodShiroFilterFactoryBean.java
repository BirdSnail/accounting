 ...
 */
@Slf4j
public class HttpMethodShiroFilterFactoryBean extends ShiroFilterFactoryBean {
    ...
    protected AbstractShiroFilter createInstance() throws Exception {
        ...
        PathMatchingFilterChainResolver chainResolver = new HttpMethodAndPathMatchingFilterChainResolver();
